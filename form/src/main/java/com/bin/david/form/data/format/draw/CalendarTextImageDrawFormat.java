...
public abstract class CalendarTextImageDrawFormat<T> extends ImageResDrawFormat<T>
{
    ...
    public CalendarTextImageDrawFormat (int imageWidth, int imageHeight, int drawPadding)
    {
    ...
    public CalendarTextImageDrawFormat (
            int imageWidth, int imageHeight, int direction,
            int drawPadding)
    {
    ...
    private void drawText (Canvas c, String value, Rect rect, Paint paint, TableConfig config)
    {

        config.getContentStyle().fillPaint(paint);
        if (config.getCalendarTitleStyle() != null)
        {
            FontStyle frontStyle = config.getCalendarTitleStyle();
