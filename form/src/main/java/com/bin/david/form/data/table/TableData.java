...
public class TableData<T>
{
     ...
     */
    public TableData (
            String tableName, List<T> t, List<Column> columns,
                    ...
                    for (int j = firstCol; j <= lastCol; j++)
                    {
                        if (j < tableCells[i].length)
                        {
                            if (i == firstRow && j == firstCol)
                            {
                                ...
                                int colCount =
                                        Math.min(lastCol + 1, tableCells[i].length) - firstCol;
                ...
                column.setOnColumnItemClickListener(new OnColumnItemClickListener()
                {
                    ...
                    public void onClick (Column column, String value, Object t, int position)
                    {
                        ...
                        if (onItemClickListener != null)
                        {
                            ...
                            TableData.this.onItemClickListener.onClick(column, value, t, index,
                                    position);
                        }
                    }
                });
        ...
        if (this.onRowClickListener != null)
        {
            setOnItemClickListener(new OnItemClickListener()
            {
                ...
                public void onClick (Column column, String value, Object o, int col, int row)
                {
                    ...
                    TableData.this.onColumnClickListener.onClick(column, column.getDatas(), col,
                            row);
                }
            });
        }
