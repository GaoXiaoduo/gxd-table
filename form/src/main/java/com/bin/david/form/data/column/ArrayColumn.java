...
public class ArrayColumn<T> extends Column<T>
{
    ...
    public ArrayColumn (
            String columnName, String fieldName, boolean isThoroughArray,
            IFormat<T> format)
    {
    ...
    public ArrayColumn (
            String columnName, String fieldName, boolean isThoroughArray,
            IFormat<T> format, IDrawFormat<T> drawFormat)
    {
                                                  ...
                                                  IllegalAccessException
    {
        ...
        //        }
        //
        //        List<T> columnData = objects.get(this.getColumnName());
        //
        //        int lineSize = objects.get(0).size();
        //        if (lineSize > 0)
        //        {
     ...
     * @throws IllegalAccessException
     */
    protected void getFieldData (
            String[] fieldNames, int start, Object child, int level,
            boolean isFoot) throws NoSuchFieldException, IllegalAccessException
    {
