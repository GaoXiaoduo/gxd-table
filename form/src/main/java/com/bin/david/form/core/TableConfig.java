...
public class TableConfig
{
     ...
     * 是否固定左侧颜色条
     */
    private boolean fixedYColorBar = false;
     ...
     * @return
     */
    public int getYColorBarWidth ()
    {

        return yColorBarWidth;
    }

    /**
     * 设置左侧颜色条宽度
     *
     * @param yColorBarWidth
     *
     * @return
     */
    public TableConfig setYColorBarWidth (int yColorBarWidth)
    {

        this.yColorBarWidth = yColorBarWidth;
        return this;
    }

    public boolean isFixedYColorBar ()
    {

        return fixedYColorBar;
    }

    public TableConfig setFixedYColorBar (boolean fixedYColorBar)
    {

        this.fixedYColorBar = fixedYColorBar;
        return this;
    }
     ...
     * @return
     */
    public int[] getYColorBarArray ()
    {

        return yColorBarArray;
    }

    /**
     * 设置左侧颜色条颜色值数组
     *
     * @param yColorBarArray 左侧颜色条颜色值数组
     *
     * @return
     */
    public TableConfig setYColorBarArray (int[] yColorBarArray)
    {

        this.yColorBarArray = yColorBarArray;
        return this;
    }
    ...
    public boolean isShowYColorBar ()
    {

        return isShowYColorBar;
    }

    public TableConfig setShowYColorBar (boolean showColorBar)
    {

        isShowYColorBar = showColorBar;
        return this;
    }
