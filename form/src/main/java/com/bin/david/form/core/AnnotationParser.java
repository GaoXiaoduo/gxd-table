...
public class AnnotationParser<T>
{
        ...
        if (dataList != null && dataList.size() > 0)
        {
            ...
            if (firstData != null)
            {
                ...
                Annotation tableAnnotation =
                        clazz.getAnnotation(com.bin.david.form.annotation.SmartTable.class);
                if (tableAnnotation != null)
                {
                    com.bin.david.form.annotation.SmartTable table =
                            (com.bin.david.form.annotation.SmartTable) tableAnnotation;
                    List<Column> columns = new ArrayList<>();
                    PageTableData<T> tableData = new PageTableData<>(table.name(),
                            dataList, columns);
     ...
     */
    private void getColumnAnnotation (
            Class clazz, String parentFieldName, List<Column> columns,
            Map<String, Column> parentMap, boolean isArray)
    {
        ...
        for (Field field : fields)
        {
            ...
            if (fieldAnnotation != null)
            {
                ...
                {
                    String fieldName = parentFieldName != null ?
                            (parentFieldName + field.getName()) : field.getName();
                ...
                else if (type == ColumnType.ArrayChild || type == ColumnType.ArrayOwn)
                {
                    ...
                    {
                        createColumn(fieldName, field, columns, parentMap, true, false,
                                smartColumn);
                    }
                    else
                    {
    ...
    private void createColumn (
            String fieldName, Field field, List<Column> columns, Map<String,
            Column> parentMap, boolean isArray, boolean isThoroughArray, SmartColumn smartColumn)
    {
